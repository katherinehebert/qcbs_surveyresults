---
title: <center> <h1>Soutien étudiant au CSBQ<br>Student support for the QCBS</h1> </center>
...
```{r pie chart of time as member and geopoles, echo = FALSE, fig.width=10, fig.align="center"}
# wrangle data
...
```{r pie chart past members, echo = FALSE, fig.align="left", fig.width = 5}
# wrangle data
...
## Vision du CSBQ des étudiants / Students' view of the QCBS
